...
cd /tmp
wget -O setup.txt -nv https://raw.githubusercontent.com/Tronje-the-Falconer/Pi-Ager/entwicklung/RPi5/boot/firmware/setup.txt
...
UPDATE config SET value='-2.5' WHERE key='hysteresis_offset';

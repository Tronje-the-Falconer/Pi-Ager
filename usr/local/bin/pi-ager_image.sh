...
UPDATE config SET value='6' WHERE key='heating_hysteresis';
UPDATE config SET value='3.0' WHERE key='humidifier_hysteresis';
UPDATE config SET value='5.0' WHERE key='dehumidifier_hysteresis';
UPDATE config SET value='-2.5' WHERE key='humidifier_hysteresis_offset';
UPDATE config SET value='0' WHERE key='dehumidifier_hysteresis_offset';
UPDATE config SET value='0' WHERE key='delay_humidify';

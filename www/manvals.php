...
                                             to avoid a wild switching on and off, the humidification should be delayed (5-10min)!').
                                        ...
                                        <table style="width: 100%;" class="miniature_writing">
                                            <tr>
                                                ...
                                                <td class="text_left_padding"><input name="setpoint_temperature_settings" type="number" min="0" max="22" required value=<?php echo $setpoint_temperature; ?>>°C<span class="display_none" style="font-size: xx-small"> (0 <?php echo _('to'); ?> 22)</span></td>
                                            </tr>
                                            <tr>
                                                <td>&nbsp;</td>
                                                <td>&nbsp;</td>
...
                                             first, the current temperature is determined. Then decide which method (cooling or heating) is suitable to reach the setpoint temperature set.
                                        ...
                                        <table style="width: 100%;" class="miniature_writing">
                                            <tr>
                                                ...
                                                <td class="text_left_padding"><input name="setpoint_humidity_settings" type="number" min="0" max="99" required value=<?php echo $setpoint_humidity; ?>>%<span class="display_none" style="font-size: xx-small"> (0 <?php echo _('to'); ?> 99)</span></td>
                                            </tr>
                                        </table>
                                        <script>
                                        ...
                                        <table style="width: 100%;" class="miniature_writing">
                                            <tr>
                                                ...
                                                <td class="text_left_padding"><input type="number" min="0" max="1440" name="circulation_air_period_settings" required value=<?php echo round($circulation_air_period); ?>><?php echo _('minutes'); ?><span class="display_none" style="font-size: xx-small"> (0 <?php echo _('to'); ?> 1440)</span></td>
                                            </tr>
                                            <tr>
                                                <td class="text_left_padding"><?php echo _('for the duration of'); ?></td>
                                                <td class="text_left_padding"><input type="number" min="0" max="1440" name="circulation_air_duration_settings" required value=<?php echo $circulation_air_duration; ?>><?php echo _('minutes'); ?><span class="display_none" style="font-size: xx-small"> (0=<?php echo _('off'); ?>)</span></td>
                                            </tr>
                                            <tr>
                                                <td>&nbsp;</td>
                                                <td>&nbsp;</td>
                                        ...
                                        <table style="width: 100%;" class="miniature_writing">
                                            <tr>
                                                ...
                                                <td class="text_left_padding"><?php echo _('period every'); ?> </td>
                                                <td class="text_left_padding"><input type="number" min="0" max="1440" name="exhaust_air_period_settings" required value=<?php echo round($exhaust_air_period); ?>><?php echo _('minutes'); ?><span class="display_none" style="font-size: xx-small"> (0 <?php echo _('to'); ?> 1440)</span></td>
                                            </tr>
                                            <tr><td class="text_left_padding"><?php echo _('for the duration of'); ?></td>
                                                <td class="text_left_padding"><input type="number" min="0" max="1440" name="exhaust_air_duration_settings" required value=<?php echo $exhaust_air_duration; ?>><?php echo _('minutes'); ?><span class="display_none" style="font-size: xx-small"> (0=<?php echo _('off'); ?>)</span></td>
                                            </tr>
                                            <tr>
                                                <td>&nbsp;</td>
                                                <td>&nbsp;</td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="td_submitbutton">
                                                    <button class="art-button" name="manvals_form_submit" type="submit" required value="manvals_form_submit" onclick="return confirm('<?php echo _('save'); echo ' '; echo _('manual values'); ?>?')"><?php echo _('save'); ?> </button>
                                                </td>
                                            </tr>
                                        </table>
                                        <script>

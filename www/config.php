                                        ...
                                        <div class="hg_container" >
                                            ...
                                            <table style="width: 100%;" class="miniature_writing">
                                                <tr>
                                                    ...
                                                    <td class="text_left_padding"><input name="switch_on_cooling_compressor_config" type="number" min="0" max="10" required value=<?php echo $switch_on_cooling_compressor; ?>>°C
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text_left_padding"><input name="switch_off_cooling_compressor_config" type="number" min="0" max="10" required value= <?php echo $switch_off_cooling_compressor; ?>>°C
                                                        <span class="display_none" style="font-size: xx-small">
                                                            <?php 
                                                                if($modus == 0 || $modus == 1){
                                            ...
                                            <table style="width: 100%;" class="miniature_writing">
                                                <tr>
                                                    ...
                                                    <td class="text_left_padding"><?php echo _('switch-on value').':'; ?></td>
                                                    <td class="text_left_padding"><input name="switch_on_humidifier_config" type="number" min="0" max="10" required value=<?php echo $switch_on_humidifier; ?>>%<span class="display_none" style="font-size: xx-small">
                                                    <?php 
                                                ...
                                                <tr>
                                                    <td class="text_left_padding"><?php echo _('switch-off value').':'; ?></td>
                                                    <td class="text_left_padding"><input name="switch_off_humidifier_config" type="number" min="0" max="10" required value=<?php echo $switch_off_humidifier; ?>>%<span class="display_none" style="font-size: xx-small">
                                                    <?php 
                                                                if($modus == 0 || $modus == 1 || $modus == 2){
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text_left_padding"><input name="delay_humidify_config" type="number" min="0" max="60" required value=<?php echo $delay_humidify; ?>><?php echo _('minutes'); ?><span class="display_none" style="font-size: xx-small"> (0 <?php echo _('to'); ?> 60)</span></td>
                                                </tr>
                                            </table>
                                            <script>
                                            ...
                                            <table style="width: 100%;" class="miniature_writing">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text_left_padding"><input name="uv_period_config" type="number" min="0" max="1440" required value=<?php echo $uv_period; ?>><?php echo _('minutes'); ?><span class="display_none" style="font-size: xx-small"> (0 <?php echo _('to'); ?> 1440)</span>
                                                    </span></td>
                                                </tr>
                                                <tr>
                                                    <td class="text_left_padding"><?php echo _('duration'); ?>:</td>
                                                    <td class="text_left_padding"><input name="uv_duration_config" type="number" min="0" max="1440" required value=<?php echo $uv_duration; ?>><?php echo _('minutes'); ?><span class="display_none" style="font-size: xx-small"> (0=<?php echo _('off'); ?>)</span></td>
                                                </tr>
                                                                                                <tr>
                                                    <td class="text_left_padding"><?php echo _('timestamp'); ?>:</td>
                                                    <td class="text_left_padding"><input name="switch_on_uv_hour_config" type="number" min="0" max="23" required value=<?php echo $switch_on_uv_hour; ?>> : <input name="switch_on_uv_minute_config" type="number" min="0" max="59" value=<?php echo $switch_on_uv_minute; ?>><?php echo _("o'clock"); ?></td>
                                                </tr>
                                            </table>
                                            <script>
                                            ...
                                            <table style="width: 100%;" class="miniature_writing">
                                                ...
                                                <tr>
                                                    <td class="text_left_padding"><?php echo _('period every').':'; ?></td>
                                                    <td class="text_left_padding"><input name="light_period_config" type="number" min="0" max="1440" required value=<?php echo $light_period; ?>><?php echo _('minutes'); ?><span class="display_none" style="font-size: xx-small"> (0 <?php echo _('to'); ?> 1440)</span>
                                                    </span></td>
                                                </tr>
                                                <tr>
                                                    <td class="text_left_padding"><?php echo _('duration'); ?>:</td>
                                                    <td class="text_left_padding"><input name="light_duration_config" type="number" min="0" max="1440" required value=<?php echo $light_duration; ?>><?php echo _('minutes'); ?><span class="display_none" style="font-size: xx-small"> (0=<?php echo _('off'); ?>)</span></td>
                                                </tr>
                                                                                                <tr>
                                                    <td class="text_left_padding"><?php echo _('timestamp'); ?>:</td>
                                                    <td class="text_left_padding"><input name="switch_on_light_hour_config" type="number" min="0" max="23" required value=<?php echo $switch_on_light_hour; ?>> : <input name="switch_on_light_minute_config" type="number" min="0" max="59" value=<?php echo $switch_on_light_minute; ?>><?php echo _("o'clock"); ?></td>
                                                </tr>
                                            </table>
                                            <script>
                                            ...
                                            <table style="width: 100%;" class="miniature_writing">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text_left_padding"><input name="failure_humidity_delta_config" type="number" min="0" max="10" required value=<?php echo $failure_humidity_delta; ?>></td>
                                                </tr>
                                                <tr>
                                                    <td class="text_left_padding"><?php echo _('failure temperature delta').':'; ?></td>
                                                    <td class="text_left_padding"><input name="failure_temperature_delta_config" type="number" min="0" max="5" required value=<?php echo $failure_temperature_delta; ?>></td>
                                                </tr>
                                            </table>
                                            <script>

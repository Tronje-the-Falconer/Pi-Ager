                ...
                <div id="Modus" style="height: 281px">
                    <form action="set.php" method="post" >
                        ...
                        <fieldset name="Group2">
                            ...
                            <p>
                                Temperatur:  <input name="temp" size="1" type="text" min="-2" max="22" value=<?=$tempsoll_float?>>°C&nbsp;&nbsp;    
                                Luftfeuchtigkeit:  <input name="hum" size="1" type="text" value=<?=$humsoll_float?>> %<br>
                                Befeuchtungsverzögerung:<input name="humdelay" size="1" type="text" value="2"/> Minuten
                            </p>
                        </fieldset>
                        <br>
                        <fieldset name="Group1">
                            <legend class="auto-style1">Lüfter</legend>
                            <p>Luftaustausch alle
                                <span lang="de-lu"> </span>
                        ...
                        <fieldset name="Group1">
                            ...
                            <p>Luftfeuchtigkeit</p>
                             Einschaltwert
                             <span lang="de-lu"> 
                                <input name="humhyston" type="text" size="2" value=<?=$humhyston?>>
                            </span>%

...
class cl_fact_i2c_sensor_sht(ABC):
    ...
    def get_instance(self, i_active_sensor, i_i2c_bus, i_address):
        ...
        try:
            ...
            cl_fact_logger.get_instance().debug("i2c __ot_instance not found for " + i_active_sensor)
            cl_fact_i2c_sensor_sht.__o_instance = None
             
        if  cl_fact_i2c_sensor_sht.__o_instance is not None :
            cl_fact_logger.get_instance().debug("Returning i2c __ot_instance = " + str(cl_fact_i2c_sensor_sht.__o_instance))

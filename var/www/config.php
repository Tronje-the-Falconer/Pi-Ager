                                        ...
                                        <div class="hg_container" >
                                            ...
                                            <table style="width: 100%;" class="miniature_writing">
                                                <tr>
                                                    ...
                                                    <td class="text_left_padding"><?php echo _('switch-on value').':'; ?></td>
                                                    <td class="text_left_padding"><input name="switch_on_humidifier_config" type="number" min="0" max="30" required value=<?php echo $switch_on_humidifier; ?>>%<span class="display_none" style="font-size: xx-small">
                                                    <?php 
                                                ...
                                                <tr>
                                                    <td class="text_left_padding"><?php echo _('switch-off value').':'; ?></td>
                                                    <td class="text_left_padding"><input name="switch_off_humidifier_config" type="number" min="0" max="30" required value=<?php echo $switch_off_humidifier; ?>>%<span class="display_none" style="font-size: xx-small">
                                                    <?php 
                                                                if($modus == 0 || $modus == 1 || $modus == 2){

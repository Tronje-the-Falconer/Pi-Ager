...
CREATE TABLE "agingtable_Salami" (
	"id"	INTEGER NOT NULL,
	"modus"	INTEGER,
...
CREATE TABLE "agingtable_SalamiM" (
	"id"	INTEGER NOT NULL,
	"modus"	INTEGER,
	"setpoint_humidity"	INTEGER,
	"setpoint_temperature"	INTEGER,
...
CREATE TABLE "agingtable_dryaging1" (
...
CREATE TABLE "agingtable_dryaging2" (
	"id"	INTEGER NOT NULL,
	"modus"	INTEGER,
	"setpoint_humidity"	INTEGER,
	"setpoint_temperature"	INTEGER,
...
CREATE TABLE "config_current_check" (
	"id"	INTEGER NOT NULL,
...
CREATE TABLE "cooling_compressor_status" (
	"id"	INTEGER NOT NULL DEFAULT 0,
	"value"	REAL NOT NULL DEFAULT 0,
	"last_change"	INTEGER NOT NULL DEFAULT 0,
	"key"	TEXT NOT NULL DEFAULT 0,
...
DROP TABLE IF EXISTS "dehumidifier_params";
CREATE TABLE "dehumidifier_params" (
	"id"	INTEGER NOT NULL,
	"setpoint_temp"	INTEGER,
	"delay_dehumidifier"	INTEGER,
	"offset_dehumidifier"	INTEGER,
	PRIMARY KEY("id" AUTOINCREMENT)
);
...
CREATE TABLE "exhaust_air_status" (
	"id"	INTEGER NOT NULL DEFAULT 0,
	"value"	REAL NOT NULL DEFAULT 0,
	"last_change"	INTEGER NOT NULL DEFAULT 0,
	"key"	TEXT NOT NULL DEFAULT 0,
...
DROP TABLE IF EXISTS "humidifier_params";
CREATE TABLE "humidifier_params" (
	"id"	INTEGER NOT NULL,
	"setpoint_temp"	INTEGER,
	"delay_humidifier"	INTEGER,
	"offset_humidifier"	INTEGER,
	PRIMARY KEY("id" AUTOINCREMENT)
);
DROP TABLE IF EXISTS "humidifier_status";
CREATE TABLE "humidifier_status" (
	"id"	INTEGER NOT NULL DEFAULT 0,
	"value"	REAL NOT NULL DEFAULT 0,
	"last_change"	INTEGER NOT NULL DEFAULT 0,
	"key"	TEXT NOT NULL DEFAULT 0,
...
DROP TABLE IF EXISTS "temperature_control_params";
CREATE TABLE "temperature_control_params" (
	"id"	INTEGER NOT NULL,
	"setpoint_temp"	INTEGER,
	"cooler_offset"	REAL,
	"heater_offset"	REAL,
...
INSERT INTO "config" ("id","key","value","last_change") VALUES (1,'cooling_hysteresis',1.6,1767948600);
INSERT INTO "config" ("id","key","value","last_change") VALUES (2,'heating_hysteresis',5.0,1767948600);
...
INSERT INTO "config" ("id","key","value","last_change") VALUES (5,'delay_humidify',10.0,1767948600);
INSERT INTO "config" ("id","key","value","last_change") VALUES (6,'sensortype',3.0,1582013839);
INSERT INTO "config" ("id","key","value","last_change") VALUES (7,'language',1.0,1743026441);
INSERT INTO "config" ("id","key","value","last_change") VALUES (8,'switch_on_light_hour',12.0,1767948600);
INSERT INTO "config" ("id","key","value","last_change") VALUES (9,'switch_on_light_minute',30.0,1767948600);
INSERT INTO "config" ("id","key","value","last_change") VALUES (10,'light_duration',0.0,1767948600);
INSERT INTO "config" ("id","key","value","last_change") VALUES (11,'light_period',86400.0,1767948600);
INSERT INTO "config" ("id","key","value","last_change") VALUES (12,'light_modus',0.0,1767948600);
INSERT INTO "config" ("id","key","value","last_change") VALUES (13,'switch_on_uv_hour',11.0,1767948600);
INSERT INTO "config" ("id","key","value","last_change") VALUES (14,'switch_on_uv_minute',30.0,1767948600);
INSERT INTO "config" ("id","key","value","last_change") VALUES (15,'uv_duration',86400.0,1767948600);
INSERT INTO "config" ("id","key","value","last_change") VALUES (16,'uv_period',0.0,1767948600);
INSERT INTO "config" ("id","key","value","last_change") VALUES (17,'uv_modus',1.0,1767948600);
INSERT INTO "config" ("id","key","value","last_change") VALUES (18,'dehumidifier_modus',2.0,1767948600);
INSERT INTO "config" ("id","key","value","last_change") VALUES (19,'circulation_air_period',0.0,1753388116);
INSERT INTO "config" ("id","key","value","last_change") VALUES (20,'setpoint_temperature',20.0,1753388116);
INSERT INTO "config" ("id","key","value","last_change") VALUES (21,'exhaust_air_duration',0.0,1753388116);
INSERT INTO "config" ("id","key","value","last_change") VALUES (22,'modus',4.0,1753388116);
INSERT INTO "config" ("id","key","value","last_change") VALUES (23,'setpoint_humidity',80.0,1753388116);
INSERT INTO "config" ("id","key","value","last_change") VALUES (24,'exhaust_air_period',86400.0,1753388116);
INSERT INTO "config" ("id","key","value","last_change") VALUES (25,'circulation_air_duration',86400.0,1753388116);
INSERT INTO "config" ("id","key","value","last_change") VALUES (26,'agingtable',10.0,1732464732);
...
INSERT INTO "config" ("id","key","value","last_change") VALUES (33,'meat1_sensortype',0.0,1743026441);
INSERT INTO "config" ("id","key","value","last_change") VALUES (34,'meat2_sensortype',0.0,1743026441);
INSERT INTO "config" ("id","key","value","last_change") VALUES (35,'meat3_sensortype',0.0,1743026441);
INSERT INTO "config" ("id","key","value","last_change") VALUES (36,'meat4_sensortype',0.0,1743026441);
...
INSERT INTO "config" ("id","key","value","last_change") VALUES (39,'agingtable_startperiod',1.0,1743096993);
INSERT INTO "config" ("id","key","value","last_change") VALUES (40,'agingtable_starthour',1.0,1743096993);
...
INSERT INTO "config" ("id","key","value","last_change") VALUES (50,'switch_control_uv_light',0.0,1743026441);
INSERT INTO "config" ("id","key","value","last_change") VALUES (51,'switch_control_light',0.0,1743026441);
...
INSERT INTO "config" ("id","key","value","last_change") VALUES (55,'saturation_point',93.0,1767948600);
INSERT INTO "config" ("id","key","value","last_change") VALUES (56,'humidifier_hysteresis',3.0,1767948600);
INSERT INTO "config" ("id","key","value","last_change") VALUES (57,'dehumidifier_hysteresis',2.0,1767948600);
INSERT INTO "config" ("id","key","value","last_change") VALUES (58,'humidifier_hysteresis_offset',-4.0,1767948600);
INSERT INTO "config" ("id","key","value","last_change") VALUES (59,'take_off_weight_scale1',0.0,1743026441);
INSERT INTO "config" ("id","key","value","last_change") VALUES (60,'take_off_weight_scale2',0.0,1743026441);
...
INSERT INTO "config" ("id","key","value","last_change") VALUES (63,'check_monitoring_humidifier',0.0,0);
INSERT INTO "config" ("id","key","value","last_change") VALUES (64,'dehumidifier_hysteresis_offset',2.0,1767948600);
INSERT INTO "config" ("id","key","value","last_change") VALUES (65,'cooling_hysteresis_offset',0.5,1767948600);
INSERT INTO "config" ("id","key","value","last_change") VALUES (66,'heating_hysteresis_offset',-0.5,1767948600);
INSERT INTO "config" ("id","key","value","last_change") VALUES (67,'dehumidifier_turn_off_delay',0.0,1767948600);
...
INSERT INTO "current_values" ("id","key","value","last_change") VALUES (1,'sensor_temperature',NULL,1767948743);
INSERT INTO "current_values" ("id","key","value","last_change") VALUES (2,'sensor_humidity',NULL,1767948743);
INSERT INTO "current_values" ("id","key","value","last_change") VALUES (3,'status_circulating_air',0.0,1767948743);
INSERT INTO "current_values" ("id","key","value","last_change") VALUES (4,'status_cooling_compressor',0.0,1767948743);
INSERT INTO "current_values" ("id","key","value","last_change") VALUES (5,'status_exhaust_air',0.0,1767948743);
INSERT INTO "current_values" ("id","key","value","last_change") VALUES (6,'status_heater',0.0,1767948743);
INSERT INTO "current_values" ("id","key","value","last_change") VALUES (7,'status_light',0.0,1767948743);
INSERT INTO "current_values" ("id","key","value","last_change") VALUES (8,'status_uv',0.0,1767948743);
INSERT INTO "current_values" ("id","key","value","last_change") VALUES (9,'status_humidifier',0.0,1767948743);
INSERT INTO "current_values" ("id","key","value","last_change") VALUES (10,'status_dehumidifier',0.0,1767948743);
INSERT INTO "current_values" ("id","key","value","last_change") VALUES (11,'scale1',-527.079,1767948747);
INSERT INTO "current_values" ("id","key","value","last_change") VALUES (12,'scale2',967.219,1767948747);
INSERT INTO "current_values" ("id","key","value","last_change") VALUES (13,'status_piager',0.0,1767910446);
INSERT INTO "current_values" ("id","key","value","last_change") VALUES (14,'status_agingtable',0.0,1743099908);
INSERT INTO "current_values" ("id","key","value","last_change") VALUES (15,'status_scale1',0.0,1753342026);
INSERT INTO "current_values" ("id","key","value","last_change") VALUES (16,'status_scale2',0.0,1753342032);
INSERT INTO "current_values" ("id","key","value","last_change") VALUES (17,'status_tara_scale1',0.0,1767948749);
INSERT INTO "current_values" ("id","key","value","last_change") VALUES (18,'status_tara_scale2',0.0,1767948749);
INSERT INTO "current_values" ("id","key","value","last_change") VALUES (19,'agingtable_period',0.0,1743099908);
INSERT INTO "current_values" ("id","key","value","last_change") VALUES (20,'agingtable_period_starttime',1743068195.0,1743096995);
INSERT INTO "current_values" ("id","key","value","last_change") VALUES (21,'status_light_manual',0.0,1729803095);
INSERT INTO "current_values" ("id","key","value","last_change") VALUES (22,'calibrate_scale1',0.0,1767948749);
INSERT INTO "current_values" ("id","key","value","last_change") VALUES (23,'calibrate_scale2',0.0,1767948749);
INSERT INTO "current_values" ("id","key","value","last_change") VALUES (24,'calibrate_weight',0.0,1767948749);
INSERT INTO "current_values" ("id","key","value","last_change") VALUES (25,'status_uv_manual',1.0,1743006118);
INSERT INTO "current_values" ("id","key","value","last_change") VALUES (26,'temperature_meat1',NULL,1767948743);
INSERT INTO "current_values" ("id","key","value","last_change") VALUES (27,'temperature_meat2',NULL,1767948743);
INSERT INTO "current_values" ("id","key","value","last_change") VALUES (28,'temperature_meat3',NULL,1767948743);
INSERT INTO "current_values" ("id","key","value","last_change") VALUES (29,'temperature_meat4',NULL,1767948743);
INSERT INTO "current_values" ("id","key","value","last_change") VALUES (30,'sensor_dewpoint',NULL,1767948743);
INSERT INTO "current_values" ("id","key","value","last_change") VALUES (31,'sensor_extern_temperature',NULL,1767948743);
INSERT INTO "current_values" ("id","key","value","last_change") VALUES (32,'sensor_extern_humidity',NULL,1767948743);
INSERT INTO "current_values" ("id","key","value","last_change") VALUES (33,'sensor_extern_dewpoint',NULL,1767948743);
INSERT INTO "current_values" ("id","key","value","last_change") VALUES (34,'agingtable_period_hour',1.0,1743099908);
INSERT INTO "current_values" ("id","key","value","last_change") VALUES (35,'scale1_thread_alive',0.0,1767948749);
INSERT INTO "current_values" ("id","key","value","last_change") VALUES (36,'scale2_thread_alive',0.0,1767948749);
INSERT INTO "current_values" ("id","key","value","last_change") VALUES (37,'aging_thread_alive',0.0,1767948749);
INSERT INTO "current_values" ("id","key","value","last_change") VALUES (38,'sensor_humidity_abs',NULL,1767948743);
INSERT INTO "current_values" ("id","key","value","last_change") VALUES (39,'sensor_extern_humidity_abs',NULL,1767948743);
INSERT INTO "current_values" ("id","key","value","last_change") VALUES (40,'status_humidity_check',0.0,1767948738);
INSERT INTO "current_values" ("id","key","value","last_change") VALUES (41,'MiSensor_battery',NULL,1767948743);
INSERT INTO "current_values" ("id","key","value","last_change") VALUES (42,'status_defrost',0.0,1767948743);
INSERT INTO "current_values" ("id","key","value","last_change") VALUES (43,'temperature_avg',NULL,1767948719);
INSERT INTO "current_values" ("id","key","value","last_change") VALUES (44,'humidity_avg',NULL,1767948719);
INSERT INTO "current_values" ("id","key","value","last_change") VALUES (45,'humidity_abs_avg',NULL,1767948719);
...
INSERT INTO "dehumidifier_params" ("id","setpoint_temp","delay_dehumidifier","offset_dehumidifier") VALUES (1,2,0,0);
INSERT INTO "dehumidifier_params" ("id","setpoint_temp","delay_dehumidifier","offset_dehumidifier") VALUES (2,6,0,0);
INSERT INTO "dehumidifier_params" ("id","setpoint_temp","delay_dehumidifier","offset_dehumidifier") VALUES (3,10,0,0);
INSERT INTO "dehumidifier_params" ("id","setpoint_temp","delay_dehumidifier","offset_dehumidifier") VALUES (4,14,0,0);
INSERT INTO "dehumidifier_params" ("id","setpoint_temp","delay_dehumidifier","offset_dehumidifier") VALUES (5,18,0,0);
INSERT INTO "dehumidifier_params" ("id","setpoint_temp","delay_dehumidifier","offset_dehumidifier") VALUES (6,22,0,0);
INSERT INTO "humidifier_params" ("id","setpoint_temp","delay_humidifier","offset_humidifier") VALUES (1,2,0,9);
INSERT INTO "humidifier_params" ("id","setpoint_temp","delay_humidifier","offset_humidifier") VALUES (2,6,0,6);
INSERT INTO "humidifier_params" ("id","setpoint_temp","delay_humidifier","offset_humidifier") VALUES (3,10,0,2);
INSERT INTO "humidifier_params" ("id","setpoint_temp","delay_humidifier","offset_humidifier") VALUES (4,14,3,-2);
INSERT INTO "humidifier_params" ("id","setpoint_temp","delay_humidifier","offset_humidifier") VALUES (5,18,4,-2);
INSERT INTO "humidifier_params" ("id","setpoint_temp","delay_humidifier","offset_humidifier") VALUES (6,22,5,-2);
...
INSERT INTO "system" ("id","key","value","last_change") VALUES (2,'pi_ager_version','4.1.1 build 050526',0);
...
INSERT INTO "temperature_control_params" ("id","setpoint_temp","cooler_offset","heater_offset") VALUES (4,14,0.5,-0.5);
INSERT INTO "temperature_control_params" ("id","setpoint_temp","cooler_offset","heater_offset") VALUES (5,18,0.5,-0.5);
INSERT INTO "temperature_control_params" ("id","setpoint_temp","cooler_offset","heater_offset") VALUES (6,22,0.5,-0.5);
INSERT INTO "time_meter" ("id","uv_light_seconds","pi_ager_seconds") VALUES (1,0,0);
DROP INDEX IF EXISTS "all_scales_index";
CREATE INDEX "all_scales_index" ON "all_scales" (
	"last_change"	ASC
);
DROP INDEX IF EXISTS "all_sensors_index";
CREATE INDEX "all_sensors_index" ON "all_sensors" (
	"last_change"	ASC
);
COMMIT;

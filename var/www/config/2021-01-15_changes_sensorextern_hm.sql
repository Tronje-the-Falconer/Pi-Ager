...
----
-- structure for index dewpoint_extern on table sensor_extern_dewpoint_data
----
CREATE INDEX 'dewpoint_extern' ON "sensor_extern_dewpoint_data" ("last_change" ASC);

----
-- structure for index humidity_extern on table sensor_extern_humidity_data
----
CREATE INDEX 'humidity_extern' ON "sensor_extern_humidity_data" ("last_change" ASC);
COMMIT;

                                    ...
                                    <div class="hg_container" >
                                        ...
                                        <table style="width: 100%;table-layout: fixed;">
                                            <tr>
                                                ...
                                                <td style="text-align: left;"><input name="setpoint_temperature_settings" type="number" style="width: 30%;" min="0" max="30" value=<?php echo $setpoint_temperature; ?>>&nbsp;°C<span style="font-size: xx-small"> (0 <?php echo _('to'); ?> 30)</span></td>
                                            </tr>
                                        </table>
                                        <script>

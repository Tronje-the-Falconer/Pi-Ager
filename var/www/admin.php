                                ...
                                <form method="post" name="admin">
                                    ...
                                    <table style="width: 100%;" class="miniature_writing">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text_left_padding"><input name="spikes_scale1_admin" type="number" maxlength="4" size="2" required value=<?php echo $spikes_scale1; ?>></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td class="text_left_padding"><?php echo _('spikes'); ?>:</td>
                                            <td class="text_left_padding"><input name="spikes_scale2_admin" type="number" maxlength="4" size="2" required value=<?php echo $spikes_scale2; ?>></td>
                                        </tr>
                                    </table>
                                    <script>

...
?>
                                ...
                                # wait until connection is established, NetworkManager needs reboot when WLAN0 settings were setup
                                    ...
                                    echo '<p id=\'info-message\' style=\'color: #ff0000; font-size: 20px;\'><b>' . _("NetworkManager Setup") . '</b><br>' . $reboot_datetime . '<br>' . '</p><br>';
                                    ...
                                    if ($exec_status != 0) {
                                        ...
                                        echo '<div style="text-align: center;"><p style="margin: 10px 0; padding: 5px; border: 1px solid #999; width: 70%; word-wrap: break-all; margin: auto; "> Pi-Ager is now rebooting. Disconnect your tablet, smartphone or notebook now from the Pi-Ager accesspoint and connect to your WiFi router. Then you can access your Pi-Ager by entering the IP Address ' . str_replace("/24", "", $exec_data[0]) . ' into your browser address field.</p></div><br><br>';

                                        ...
                                        <?php 
                                            ...
                                            try {
                                                ...
                                                while ($index_row < $number_rows) {
                                                    ...
                                                    echo '<td><input name="data_setpoint_temperature_edit_agingtable_' . $index_row .'" maxlength="4" style="width: 90%;" size="1" min="-11" max="30" type = "number" value=' . $data_setpoint_temperature . '></td>';

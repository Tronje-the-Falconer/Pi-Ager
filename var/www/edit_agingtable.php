                                        ...
                                        <?php 
                                            ...
                                            try {
                                                ...
                                                while ($index_row < $number_rows) {
                                                    ...
                                                    echo '<td><input name="data_setpoint_temperature_edit_agingtable_' . $index_row .'" maxlength="4" style="width: 90%;" size="1" min="-1" max="25" type = "number" value=' . $data_setpoint_temperature . '></td>';

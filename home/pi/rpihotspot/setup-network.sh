...
wirelessRulesFile="/etc/udev/rules.d/90-wireless.rules"
...
doCleanup() {
    ...
    if [ -f "$wirelessRulesFile" ]; then
        echo "[Remove]: $wirelessRulesFile"
        rm -f $wirelessRulesFile
    fi
